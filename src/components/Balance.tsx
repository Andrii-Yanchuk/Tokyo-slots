...
export function Balance(props: BalanceProps) {
  ...
  return (
    <footer className="relative mt-auto flex h-50 w-full flex-col items-center justify-end md:h-60">
      {/* 🌆 МІСТО (нижче) */}
      <div className="hidden md:block absolute bottom-20 w-full h-60 bg-[url('/tokiocity.svg')] bg-[length:100%_100%] bg-repeat lg:h-80 pointer-events-none" />

      {/* ☁️ ХМАРИ (вище) */}
      <div className="absolute inset-0 bg-[url('/cloud-mob.png')] bg-[length:100%_100%] bg-center bg-no-repeat z-10 md:bg-[url('/cloud-dt.png')] pointer-events-none" />

      {/* 💰 КОНТЕНТ (найвище) */}
      <div className="relative z-20 flex flex-col items-center justify-end">
        <p className="text text-4xl text-[#FFC434]">Balance</p>

        <div className="flex h-19 w-62.5 items-center justify-center gap-2 bg-[url('/balance-bg.png')] bg-[length:100%_100%] bg-center bg-no-repeat">
